...
public class MyPostMethod {
    ...
    public String login(HttpServletResponse response,
                        @RequestParam(value = "useName",required = true)String userName,
    ...
    public String getUserList(HttpServletRequest request, @RequestBody User u){
        ...
        for (Cookie c:cookies){
            if (c.getName().equals("login") && c.getValue().equals("true")&&u.getUserName().equals("lxy") &&u.getPassword().equals("123456")){
                user = new User();
                user.setName("lisi");
                user.setAge("18");
                user.setSex("man");
